...
def readData():
    ...
    return singleName + singleContain + short_name + contains, full_name_process
        ...
        for item in croped_images:
            ...
            if isMedicine >= 50: #xét trường hợp tên thuốc == từ điển thì xuất ra ~ 100% matching => handle case này riêng
                ...
                if percent_match >= 90:
                    ...
                    final_result.append([{'line': '', 'display_name': medicine_name, 'morning': '1', 'afternoon': '1', 'evening': '1', 'info': 'Thông tin đang được cập nhật', 'contains': ''}])
        return final_result
